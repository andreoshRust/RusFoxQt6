...
Предупреждение !!!  Язык программирования новый. Многие классы созданы, заявлены, но не протестированы. Имеется сценарий ВсеТесты.RUS, в который я буду добавлять новые тесты.
Для данного языка программирования удобно использовать этот редактор http://perfolenta.net/   
...
RusFoxQt6 — язык для тех, кто хочет программировать на русском с мощью Qt6

...
Саму программу RusFoxQt6 v2.1 можно взять здесь    https://TransFiles.ru/dxzpq   (ссылка действует до 19.06.2026 05:16)  Если у вас была старая версия RusFoxQt6 на компе, то перед запуском новой версии надо очистить кэш, запустив newVersionRusFoxQt6.bat . После этого загрузчик развернёт во временном каталоге новые файлы для запуска.
